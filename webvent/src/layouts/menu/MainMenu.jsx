...
export default function MainMenu(){
    ...
    <ul className="nav nav-primary">
        ...
        <li className="nav-item">
            ...
            <div className="collapse" id="base">
                <ul className="nav nav-collapse">
                    ...
                    <li>
                        <Link to={`/personas`}>
                            <span className="sub-item">Personas</span>
                        </Link> 
                    </li>
                    <li>
        ...
        <li className="mx-4 mt-2">
            <a href="http://themekita.com/atlantis-bootstrap-dashboard.html" className="btn btn-primary btn-block"><span className="btn-label mr-2"> <i className="fa fa-heart"></i> </span>Buy Pro</a> 
        </li>
    </ul>
